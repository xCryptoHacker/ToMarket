## I will send you a code make the code thoss type the code first featch user data then fetch how many start have the user on the data then it started play with the starts and earn by tap,swap by claim the falling tomato here is python code take all necessary item from this import os
import sys
import json
import time
import os
...
class Tomartod:
    ...
    {hijau}By: {putih}t.me/xCryptoHacker
    {hijau}GIthub: {putih}@xDcryptoHacker
    
    {hijau}Message: {putih} Join Our Telegram For More Mining Hack Tool.!! 
        """
